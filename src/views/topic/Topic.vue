                ...
                <div class="topic-top">
                    ...
                    <div class="topic-bottom">
                        <div class="topic-info">
                            ...
                            <span>
                                • {{ detail.visit_count }} 次浏览 • 最后一次编辑是 {{ detail.last_reply_at | fromNow }} • 来自 {{ detail.tab | comeFrom }}
                            </span>
                        </div>
    ...
    methods: {
        ...
        insertReply () {
            ...
            axios.post(`${API_CONFIG.replies}${this.detail.id}/replies`, {
                content: `${val}   \n\n\n[来自第三方vue-cnode](https://github.com/LeoPoeX/Cnode)`,
            })
            .then(res => {
                if( res.data.success ) {
        ...
        likeBtn (id, author, index) {
            try {
                if( !this.isLogin ) throw new Error('您未登录!');
