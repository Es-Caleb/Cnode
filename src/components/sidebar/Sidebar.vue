  ...
  <aside class="sidebar">
    <div class="personal-information">
      ...
      <div v-else>
        ...
        <div class="info user-select-none">
          <router-link
            :to="{ name: 'User', params: { loginname: author.loginname } }"
          >
    ...
    <div class="pay pointer-events-none">
      <div>如果这个项目可以帮到您，那么您可以</div>
      <Carousel autoplay loop :autoplay-speed="5000">
        <CarouselItem>
          <div>
            <img src="../../assets/images/wechat.jpg" alt="支付宝" />
          </div>
        </CarouselItem>
        <CarouselItem>
          <div>
  ...
  props: {
    ...
    author: {
      ...
      default() {
        return {
          avatar_url:
            "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAMAAAACAQMAAACnuvRZAAAAA1BMVEX29vYACyOqAAAACklEQVQI12MAAgAABAABINItbwAAAABJRU5ErkJggg==", //头像
          id: "", //用户id
          loginname: "" //用户
        };
      }
